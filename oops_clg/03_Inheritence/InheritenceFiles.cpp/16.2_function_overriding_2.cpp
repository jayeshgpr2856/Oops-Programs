...
//Function Overriding in Multiple Inheritence
...
class Student
{
   ...
   public:
   	...
   	void fun()
   	{
   		cout<<endl<<"Function of Student"<<endl;
   	}
   ...
   void input_student()
	...
	void display() // void display() if used in both class will cause ambiguity
	{
...
class Internal_Marks
{
	...
	protected:
		...
		void fun()
   		...
   		cout<<endl<<"Function of Internal_Marks"<<endl;
...
class External_Marks
{
	...
	protected:
		...
		void fun()
   		...
   		cout<<endl<<"Function of External_Marks"<<endl;
...
class result: public Student, public Internal_Marks, public External_Marks 
{
	...
	public:
		...
		void fun()
   		...
   		cout<<endl<<"Function of result"<<endl<<endl;
...
int main()
{
	...
	student1.Student::fun();
	
	student1.Internal_Marks::fun();
	
	student1.External_Marks::fun();
	
	student1.fun();  // or student1.result::fun();
